...
<body>
    ...
    <div class="container">
        <div class="box">
            ...
            <div class="box-login" id="login">
				<div style="display: flex; justify-content: center; align-items: center; margin-top: -30px;">
                    <a href="./">
					    <img src="{{ asset('template/assets/img/prlogov3.png') }}" alt="" width="100" height="100">
                    </a>
				</div>
        ...
        <div style="position: fixed; left: 50%; transform: translateX(-50%); top: calc(50% + 250px); z-index: 100; font-size: 8pt; margin-top: 5px; color: #353131; text-align: center;">
			Maintained and Managed by <br> Management Information System Office (MISO) <br> under the Leadership of Dr. Aladino C. Moraca.
		</div>
    </div>
