                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            var buttons = '<button type="button" class="btn btn-sm btn-success btn-prpdfchecking mb-1 text-light" data-id="' + row.pid + '"  data-toggle="tooltip" data-placement="top" title="View PR."><i class="fas fa-file-pdf"></i></button>'+'&nbsp;';
                                buttons += '<button type="button" class="btn btn-sm btn-primary btn-prremarkschecking mb-1" data-id="' + row.pid + '" data-purposeid="' + row.pid + '" data-officeid="' + row.office_id + '" data-campid="' + row.camp_id + '" data-trnsacno="' + row.transaction_no + '" data-userid="' + row.user_id + '" data-purposename="' + row.purpose_name + '"  data-toggle="tooltip" data-placement="top" title="View PR."><i class="fas fa-eye"></i></button>'+'&nbsp;';
