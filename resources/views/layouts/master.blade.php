...
<link rel="stylesheet" href="{{ asset('template/assets/js/tables/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('template/assets/js/tables/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('template/assets/js/tables/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
...
<style>
    ...
    body.sidebar-mini .main-sidebar, .main-sidebar.sidebar-mini, body.sidebar-collapsed .main-sidebar, .main-sidebar.sidebar-collapsed {
...
<div id="app">
    <div class="main-wrapper main-wrapper-1" style="background-color: #f4f6f9;">
        ...
        <nav class="navbar navbar-expand-lg main-navbar" style="background: linear-gradient(135deg, #3a7d5c 0%, #1f5036 100%); position: fixed; margin-top: 15px; border-radius: 5px; margin-right: 0; z-index: 999">
            <form class="form-inline mr-auto">
                ...
                <div class="search-element">
                    <input class="form-control" type="search" value="Balance: 2, 500, 530.00" aria-label="Search" data-width="250" style="background-color: rgb(47, 107, 77); border-radius: 5px; color: #fff">
                </div>
            </form>
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="d-sm-none d-lg-inline-block text-white">Hi, Joshua Kyle</div>
                    </a>
        ...
        <div class="main-sidebar sidebar-style-2" style="background: linear-gradient(135deg, #3a7d5c 0%, #1f5036 100%);">
        ...
        <footer class="main-footer">
            <div style="background: linear-gradient(135deg, #ffffff 0%, #f8f8f8 50%, #ececec 100%); border-radius: 5px; padding: 10px;">&nbsp;
                <div class="footer-left">
                    <div>Maintained and Managed by Management Information System Office (MISO) under the Leadership of Dr. Aladino C. Moraca.</div>
                </div>
