                    ...
                    <div class="col-md-12">
                        <div class="card card-animate">
                            <div class="card-header pt-3">
                                <h6 class="card-title">
                                    <i class="fas fa-list"></i> List of PR Cart
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive mt-2 p-2">
                                    <table id="example1" class="table table-hover styled-table">
                                        ...
                                        <tbody id="tbody">
                                            ...
                                            <tr id="tr-{{ $data->purpose_Id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <button type="button" class="btn btn-icon btn-info" data-bs-toggle="modal" data-bs-target="#modal-editpurpose-{{ $data->purpose_Id }}" data-purpose="{{ $data->purpose_name }}">
                                                            <i class="fas fa-pen"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-icon btn-success" data-bs-toggle="modal" data-bs-target="#modal-trackpurpose-{{ $data->purpose_Id }}" data-purpose="{{ $data->ppmp_remarks }}">
                                            ...
                                            <div class="modal fade" id="modal-editpurpose-{{ $data->purpose_Id }}" tabindex="-1" role="dialog" aria-labelledby="editPurposeLabel" aria-hidden="true" style="z-index: 99999">
