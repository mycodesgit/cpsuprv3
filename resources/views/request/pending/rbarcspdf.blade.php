		...
		<thead>
			...
			<tr>
				...
				<th style="text-align:left; font-size:8pt;">
					@if($reqitem->first()->pstatus == 3)
						@if($reqitem->first()->ppmp_remarks)
							From Procurement:  {{ $reqitem->first()->ppmp_remarks }} <br>
						@endif

						@if($reqitem->first()->reasons)
							From Budget:  {{ $reqitem->first()->reasons }}
						@endif
					@endif
				</th>
			</tr>
