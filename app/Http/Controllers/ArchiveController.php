...
class ArchiveController extends Controller
{
    ...
    public function archiveRead() 
    {
        ...
        return view("archived.list_archived", compact('data'));
    }
    ...
    public function archiveShow(Request $request) 
    {
        ...
        return view("archived.listsearch_archived", compact('data', 'prarchivedata'));
    }

    public function getarchivedprListRead(Request $request) 
    {
        $year = $request->input('year');
